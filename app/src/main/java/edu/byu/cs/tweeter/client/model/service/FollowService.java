...
public class FollowService {
    ...
    private class GetFollowingHandler extends Handler {
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            if (success) {
                List<User> followees = (List<User>) msg.getData().getSerializable(GetFollowingTask.MESSAGE_KEY);
    ...
    private class GetFollowersHandler extends Handler {
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            if (success) {
                List<User> followers = (List<User>) msg.getData().getSerializable(GetFollowersTask.MESSAGE_KEY);
